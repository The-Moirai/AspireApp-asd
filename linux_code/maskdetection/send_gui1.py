...
# client_socket=ex.build_send_server('43.142.158.16', 12345)
client_socket=ex.build_send_server('192.168.137.1', 12345)
	...
	def video_loop1(self, panela):
		...
		def read_img():
			...
			if success:
				...
				ex.send_to_server(client_socket,img)
		def get_ans():
            

			ans = ex.recv_from_server(client_socket)
		...
		t1=Thread(target=read_img)
		t2=Thread(target=get_ans)
		t1.start()
		t2.start()
